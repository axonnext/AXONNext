...
try:
    ...
    raise unittest.SkipTest("stdlib test.mapping_tests unavailable (distro testsuite not installed)")
...
#                         pickle.loads(pickle.dumps(od, 3))),
    ...
    def test_pickle_recursive(self):
        ...
        dup = pickle.loads(pickle.dumps(od))
...
#     suite.addTest(unittest.makeSuite(SubclassMappingTests))
#     suite.addTest(unittest.makeSuite(GeneralMappingTests))
    return suite
